...
# Orwell.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :orwell, Orwell.Web.Endpoint,
  ...
  url: [scheme: "https", host: System.get_env("HOST_URL"), port: 80],
...
# start per endpoint:
#
#     config :orwell, Orwell.Web.Endpoint, server: true
#
